	...
	<main class="page-content">
		...
		<div class="row">
			<div class="col-lg-12 mx-auto">
				<form class="row g-3" action="{{ route('division.store') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="card">
						<div class="card-header py-3 bg-transparent"> 
						  <div class="d-sm-flex align-items-center">
						    <h5 class="mb-2 mb-sm-0">Add New Division</h5>
							    <div class="ms-auto">
							        ...
							        <div class="card shadow-none bg-light border">
							          <div class="card-body">
								            ...
								            <div class="col-12">
								                ...
								                <input type="text" class="form-control" placeholder="Priority Number" name="priority_no" value="{{ old('priority_no') }}">
								            </div>
