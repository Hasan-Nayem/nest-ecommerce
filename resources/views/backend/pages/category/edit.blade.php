					...
					<div class="card">
						<div class="card-header py-3 bg-transparent"> 
						  <div class="d-sm-flex align-items-center">
						    <h5 class="mb-2 mb-sm-0">Update Category Information</h5>
							    <div class="ms-auto">
							        ...
							        <div class="card shadow-none bg-light border">
							          <div class="card-body">
								            ...
								            <div class="col-12">
								                ...
								                <textarea class="form-control" placeholder="Full description" rows="4" cols="4" name="description">{{ $category->description }}</textarea>
							              	</div>
