...
@section('body-content')
                          ...
                          <form class="row g-3">
                            ...
                            <div class="row">
                              <div class="col-12 col-lg-4">
                                ...
                                <input type="text" name="sku_code" value="{{old('sku_code')}}" class="form-control" placeholder="SKU">
                              </div>
                              <div class="col-12 col-lg-4">
                                <label class="form-label">Manufecture Date</label>
                                <input type="text" name="manu_date" value="{{old('manu_date')}}" class="form-control" placeholder="Color">
                              </div>
                              <div class="col-12 col-lg-4">
                                <label class="form-label">Expire Date</label>
                                <input type="text" name="exp_date" value="{{old('exp_date')}}" class="form-control" placeholder="Size">
                              </div>
                              <div class="col-12 col-lg-4">
                                <label class="form-label">Total Stock Quantity</label>
                                <input type="text" name="quantity" value="{{old('quantity')}}" class="form-control" placeholder="Size">
                              </div>
 ...
 -->
                            ...
                            <div class="col-12">
                              ...
                              <textarea id="editor" class="form-control" placeholder="Full description" name="shrt_desc" value="{{ old('shrt_desc') }}"></textarea>
                            </div>

                            <div class="col-12">
                              <label class="form-label">Long Description</label>
                              <textarea id="editor2" class="form-control" name="long_desc" value="{{ old('long_desc') }}" placeholder="Full description"></textarea>
                            </div>
                          </form>
                        </div>
                      </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                              ...
                              <div class="col-12">
                                ...
                                <input type="text" name="regular_price" value="{{ old('regular_price') }}" class="form-control" placeholder="Price">
                              </div>

                              <div class="col-12">
                                <label class="form-label">Offer Price</label>
                                <input type="text" name="offer_price" value="{{ old('offer_price') }}" class="form-control" placeholder="Price">
                              </div>
                              ...
                              <div class="col-12">
                                ...
                                <input type="text" name="meta_tags" value="{{ old('meta_tags') }}" class="form-control" placeholder="Tags">
                              </div>
                              <!-- <div class="col-12">
