				...
				<div class="card radius-10 w-100">
				    <div class="card-body" style="position: relative;">
				        <div class="d-flex align-items-center">
			                <h6 class="mb-0">Manage All District</h6>
			            </div>
		                         		...
		                         		<td>
		                          		...
		                          		<td>
				                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
				                              ...
				                              <a href="{{ route('district.edit', $district->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit" aria-label="Edit">
				                              ...
				                              <a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Delete" aria-label="Delete">
				                              	<i class="bi bi-trash-fill" data-bs-toggle="modal" data-bs-target="#deleteDistrict{{ $district->id }}"></i>
				                              </a>
				                            </div>
				                        </td>
												       		...
												       		<ul>
												       			<li>
												       				<form action="{{ route('district.destroy', $district->id ) }}" method="POST">
												       					...
												       					<input type="submit" name="district" value="Confirm" class="btn btn-danger">
												       				</form>
												       			</li>
