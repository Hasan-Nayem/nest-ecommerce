	...
	<main class="page-content">
		...
		<div class="row">
			<div class="col-lg-12 mx-auto">
				<form class="row g-3" action="{{ route('vendor.store') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="card">
							          		...
							          		<div class="col-lg-4">
									            ...
									            <div class="col-12">
									                ...
									                <select class="form-control" name="division" id="divisionId">
														...
														<option value="{{ $division->id }}"> {{ $division->name. " " .$division->namebn }} </option>
														@endforeach
									                </select>
									            </div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
	<script>
		var divisionId = document.getElementById('divisionId').val();
