                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="{{ route('cart.manage') }}"><span class="lable">Cart</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                            ...
                                            @foreach( App\Models\Cart::totalCarts() as $carts )
                                                <li>
                                                    <div class="shopping-cart-img">
                                                        <a href="{{ route('productDetails', $carts->product->slug) }}"><img alt="Nest" src="{{ asset('frontend/assets/imgs/shop/thumbnail-3.jpg') }}" /></a>
                                                    </div>
                                                    <div class="shopping-cart-title">
                                                        <h4><a href="{{ route('productDetails', $carts->product->slug) }}">{{ $carts->product->title }}</a></h4>
                                                        <h4><span>{{ $carts->product_quantity }} × </span>
                                                            @if( !is_null($carts->product->offer_price) )
                                                                {{ $carts->product->offer_price }}
                                                                @php
                                                                    $totalAmount += $carts->product->offer_price * $carts->product_quantity;
                                                                @endphp
                                                            @else
                                                                {{ $carts->product->regular_price }}
                                                                @php
                                                    ...
                                                    <div class="shopping-cart-delete">
                                                        ...
                                                        @csrf
                                                        <button type="submit" class="text-body cart-destroy-btn"><i class="fi-rs-cross-small"></i></button>
                                                        </form>
                                        ...
                                        <div class="shopping-cart-footer">
                                            ...
                                            <div class="shopping-cart-button">
                                                <a href="{{ route('cart.manage') }}" class="outline">View cart</a>
                                                <a href="{{ route('checkout') }}">Checkout</a>
                                            </div>
                                        </div>
                                        @else
                                            <p style="color:#3bb77e; font-weight:600;">No Products in the Cart</p>
                                        @endif
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    @if ( Auth::check() )
                                        ...
                                        <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                            <ul>
                                                <li>
                                                    <a href="{{ route('customerAccount') }}"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                                                </li>
                                                <li>
                                    ...
                                    @else
                                        <a href="{{ route('cus-login') }}">
                                            <img class="svgInject" alt="Nest" src="{{ asset('frontend/assets/imgs/theme/icons/icon-user.svg') }}" />
                                        </a>

                                        <a href="{{ route('cus-login') }}">
                                            <span class="lable ml-0">Login / Register</span>
                                        </a>
                                    @endif
