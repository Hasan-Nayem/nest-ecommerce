                        ...
                        <div class="row mb-50 mt-30">
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10">
                                            <img src="{{asset('backend/assets/images/products/'.$prImage->image)}}" alt="product image" />
                                        </figure>
                                        {{-- <figure class="border-radius-10">
                                            <img src="{{asset('frontend/assets/imgs/shop/product-16-1.jpg')}}" alt="product image" />
                                        </figure>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    @if ( !is_null( $prDetails->offer_price ) )
                                        <span class="stock-status in-stock"> On Sale </span>
                                    @else
                                        <span class="stock-status out-stock"> Sale Off </span>
                                    @endif

                                    <h2 class="title-detail">{{ $prDetails->title }}</h2>
                                    <div class="product-detail-rating">
                                        <div class="product-rate-cover text-end">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            @if ( !is_null( $prDetails->offer_price ) )
                                            <span class="current-price text-brand">৳{{ $prDetails->offer_price }} BDT</span>
                                            <span>
                                                @php
                                                $discountAm = $prDetails->regular_price - $prDetails->offer_price;

                                                $discountPercent = ceil($discountAm * 100 / ( $prDetails->regular_price));
                                                @endphp

                                                <span class="save-price font-md color3 ml-15">{{ $discountPercent }}% Off</span>


                                                <span class="old-price font-md ml-15">৳{{ $prDetails->regular_price }} BDT</span>
                                            </span>
                                            @else
                                                <span class="current-price text-brand">{{ $prDetails->offer_price }}</span>
                                            @endif
                                    ...
                                    <div class="detail-extralink mb-50">
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            ...
                                            <div class="detail-qty border radius">
                                                <a href="#" class="qty-down"><i class="fi-rs-angle-small-down"></i></a>
                                                <input type="text" name="product_quantity" class="qty-val" value="1" min="1">
                                                <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                            </div>
