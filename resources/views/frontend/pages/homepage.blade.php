        ...
        <section class="home-slider position-relative mb-30">
            <div class="container">
                <div class="home-slide-cover mt-30">
                    ...
                    @foreach($sliders = \App\Models\Slider::get()->where('status',1) as $slider)
                        <div class="single-hero-slider single-animation-wrap" style="background-image: url({{ asset('frontend/assets/settings/slider/'.$slider->image)  }} )">
                            <div class="slider-content">
                                <h1 class="display-2 mb-40">
                                    {{ $slider->head }}<br />
                                    <!-- grocery deals -->
                                </h1>
                                <p class="mb-65"> {{ $slider->subHead }} </p>
                                            ...
                                            <div class="product-img product-img-zoom">
                                                ...
                                                <a href="{{ route('productDetails', $product->slug ) }}">
                                                    ...
                                                    @foreach( $product->images as $image )
                                                        ...
                                                        @if ( $i > 0 )
                                                        <img class="default-img" src="{{ asset( 'backend/assets/images/products/' . $image->image )  }}" alt="{{ $product->slug }}" />
                                                        @endif
                                                    ...
                                                    @foreach( $product->images as $image )
                                                        ...
                                                        @if ( $i == 2 )
                                                        <img class="hover-img" src="{{ asset( 'backend/assets/images/products/' . $image->image )  }}" alt="{{ $product->slug }}" />
                                                        @endif
                                            ...
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    @if ( !is_null( $product->offer_price ) )
                                                        ...
                                                        <span>৳{{$product->offer_price}} BDT</span>
                                                ...
                                                <div class="add-cart">
                                                    <form action="{{ route('cart.store') }}" method="POST">
                                                        ...
                                                        <button type="submit" href="shop-cart.html">
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="{{ asset('frontend/assets/imgs/shop/product-9-1.jpg')  }}" alt="" />
                                                <img class="hover-img" src="{{ asset('frontend/assets/imgs/shop/product-9-2.jpg')  }}assets/imgs/shop/product-9-2.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
